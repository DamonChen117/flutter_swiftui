...
extension GestureDetectorExtension on Widget {
  Widget gestureDetector({
    ...
    GestureDragDownCallback? onScaleStart,
    GestureScaleUpdateCallback? onScaleUpdate,
    GestureScaleEndCallback? onScaleEnd,
    GestureTapDownCallback? onSecondaryTapDown,
    GestureTapUpCallback? onSecondaryTapUp,
    GestureTapCancelCallback? onSecondaryTapCancel,
    GestureDragDownCallback? onTertiaryTapDown,
    GestureDragUpCallback? onTertiaryTapUp,
    GestureDragCancelCallback? onTertiaryTapCancel,
    GestureDragDownCallback? onPointerDown,
    GestureDragDownCallback? onPointerMove,
    GestureDragDownCallback? onPointerUp,
    GestureDragCancelCallback? onPointerCancel,
    HitTestBehavior? behavior,
